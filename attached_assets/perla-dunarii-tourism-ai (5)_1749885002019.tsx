...
const PerlaDunariiTourismAI = () => {
  ...
  const renderCommunicationHub = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-semibold mb-4">Communication Analytics</h3>
          <div className="space-y-4">
            <div className="p-3 bg-green-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="font-medium">Response Time</span>
                <span className="text-green-600">12 seconds</span>
              </div>
              <p className="text-sm text-green-600">Average staff response</p>
            </div>
            <div className="p-3 bg-blue-50 rounded-lg">
              <div className="flex justify-between items-center">
              ...
              <p className="text-sm text-blue-600">First contact resolution</p>
            </div>
            <div className="p-3 bg-purple-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="font-medium">Languages Supported</span>
                <span className="text-purple-600">{tourismData.languagesSupported}</span>
              </div>
              <p className="text-sm text-purple-600">Real-time translation</p>
            </div>
            <div className="p-3 bg-orange-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="font-medium">Active Conversations</span>
                <span className="text-orange-600">247</span>
              </div>
              <p className="text-sm text-orange-600">Currently ongoing</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-3 border rounded-lg text-center">
              ...
              <p className="text-sm text-gray-600">Quick communication</p>
            </div>
            <div className="p-3 border rounded-lg text-center">
              <FileText className="w-8 h-8 text-orange-600 mx-auto mb-2" />
              <h4 className="font-semibold">Document Sharing</h4>
              <p className="text-sm text-gray-600">Secure file transfer</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const renderTransportSystems = () => (
    <div className="space-y-6">
      {renderCopyrightNotice()}
      
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-semibold mb-4">Intelligent Transport Integration Systems</h3>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            <h4 className="font-semibold text-blue-800">Autonomous Vehicles</h4>
            <p className="text-2xl font-bold text-blue-600 mt-2">12</p>
            <p className="text-sm text-blue-600">Self-driving tour buses</p>
          </div>
          <div className="p-4 bg-green-50 rounded-lg">
            <h4 className="font-semibold text-green-800">Electric Fleet</h4>
            <p className="text-2xl font-bold text-green-600 mt-2">89%</p>
            <p className="text-sm text-green-600">Zero emission vehicles</p>
          </div>
          <div className="p-4 bg-purple-50 rounded-lg">
            <h4 className="font-semibold text-purple-800">Route Efficiency</h4>
            <p className="text-2xl font-bold text-purple-600 mt-2">23%</p>
            <p className="text-sm text-purple-600">Fuel savings achieved</p>
          </div>
          <div className="p-4 bg-orange-50 rounded-lg">
            ...
            <p className="text-sm text-orange-600">Fleet visibility</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-semibold mb-4">Multi-Modal Transport Options</h3>
          <div className="space-y-4">
            <div className="p-3 border rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Self-driving electric buses and cars</p>
                </div>
              </div>
            </div>
            <div className="p-3 border rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-semibold">Smart Rail Systems</h4>
                  <p className="text-sm text-gray-600">High-speed electric trains</p>
                </div>
              </div>
            </div>
            <div className="p-3 border rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-semibold">Electric Water Transport</h4>
                  <p className="text-sm text-gray-600">Solar-powered river boats</p>
                </div>
              </div>
            </div>
            <div className="p-3 border rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-semibold">Drone Shuttles</h4>
                  <p className="text-sm text-gray-600">Personal aerial transportation</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-semibold mb-4">Transport Performance</h3>
          <div className="space-y-4">
            <div className="p-3 bg-green-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="font-medium">On-Time Performance</span>
                <span className="text-green-600">96.4%</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                <div className="bg-green-600 h-2 rounded-full" style={{width: '96.4%'}}></div>
              </div>
            </div>
            <div className="p-3 bg-blue-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="font-medium">Energy Efficiency</span>
                <span className="text-blue-600">{tourismData.energyEfficiency}%</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                <div className="bg-blue-600 h-2 rounded-full" style={{width: `${tourismData.energyEfficiency}%`}}></div>
              </div>
            </div>
            <div className="p-3 bg-purple-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="font-medium">Customer Satisfaction</span>
                <span className="text-purple-600">94.7%</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
  ...
  const renderSustainability = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-semibold mb-4">Comprehensive Sustainability Framework</h3>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="p-4 bg-green-50 rounded-lg">
            <h4 className="font-semibold text-green-800">Carbon Footprint</h4>
            <p className="text-2xl font-bold text-green-600 mt-2">-{tourismData.carbonFootprint}%</p>
            <p className="text-sm text-green-600">Reduction achieved</p>
          </div>
          <div className="p-4 bg-blue-50 rounded-lg">
            <h4 className="font-semibold text-blue-800">Energy Efficiency</h4>
            <p className="text-2xl font-bold text-blue-600 mt-2">{tourismData.energyEfficiency}%</p>
            <p className="text-sm text-blue-600">Renewable energy